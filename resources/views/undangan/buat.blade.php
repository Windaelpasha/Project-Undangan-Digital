...
<div class="u-body">
        <div class="card">
            ...
            <form role="form" method="post" action="{{ route('undangan.buat') }}" enctype="multipart/form-data">                            
                {{@csrf_field()}}
            <p align="center" style="margin-right: 200px;" ><input type="text" name="nama" value="{{$nama_pemesan->client['nama']}}" class="text-center form-control" style="color: #6b15b6; width: 200px;"></p>
               <div class="row" align="center">                     
                <div class="col-6" style="margin-bottom:20px; margin-top: 30px;">
                    <div class="form-group">  
                        <label class="control-label" style="margin-right: 250px; color:#6b15b6; ">Slide 1</label>
                        <div class="col-md-9">
                ...
                <div class="col-6" style="margin-top: 30px;">
                    <div class="form-group"> 
                          <label class="control-label" style="margin-right: 250px; color:#6b15b6;">Slide 4 </label>
                        <div class="col-md-9">
                             <div style="width: 140px; height: 100px; border: 1px solid #6b15b6; margin-right: 200px; margin-bottom: 10px;"> 
                ...
                <div class=" col-6" style="margin-bottom: 20px;">
                    <div class="form-group">
                            <label class="control-label" style="margin-right: 250px; color:#6b15b6;">Slide 2</label>
                        <div class="col-md-9">
                             <div style="width: 140px; height: 100px; border: 1px solid #6b15b6; margin-right: 200px; margin-bottom: 10px;">  
                ...
                <div class=" col-6 ">
                    <div class="form-group">
                            <label class="control-label" style="margin-right: 250px; color:#6b15b6;">Slide 5</label>
                        <div class="col-md-9">
                             <div style="width: 140px; height: 100px; border: 1px solid #6b15b6; margin-right: 200px; margin-bottom: 10px;">  
                ...
                <div class="col-6">
                    <div class="form-group"> 
                            <label class="control-label " style="margin-right: 250px; color:#6b15b6;">Slide 3</label>
                         <div class="col-md-9">
                            <div style="width: 140px; height: 100px; border: 1px solid #6b15b6; margin-right: 200px; margin-bottom: 10px;">     
                ...
                <div class=" col-6">
                    <div class="form-group"> 
                            <label class="control-label" style="margin-right: 250px; color:#6b15b6;">Slide 6</label>
                         <div class="col-md-9">
                            <div style="width: 140px; height: 100px; border: 1px solid #6b15b6; margin-right: 200px; margin-bottom: 10px;">     
                ...
                <button type="submit" class="btn btn-primary" style="margin-left: 900px; margin-top: 100px;" >Simpan</button>
            </form>
            </div>
        </div>
    </div>
