                              ...
                              "#2972fa",
									...
									<div class="media-body">
										<h5 class="h6 text-muted text-uppercase mb-2">
											Total Penjualan <i class="fa fa-arrow-up text-success ml-1"></i>
										</h5>
						...
						<div class="col-sm-6 col-xl-3 mb-4">
							<div class="card">
                              ...
                              "#fab633",
									...
									<div class="media-body">
										<h5 class="h6 text-muted text-uppercase mb-2">
											Pembelian <i class="fa fa-arrow-down text-danger ml-1"></i>
										</h5>
										<span class="h2 mb-0">700</span>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-xl-3 mb-4">
							<div class="card">
                              ...
                              "#0dd157",
									...
									<div class="media-body">
										<h5 class="h6 text-muted text-uppercase mb-2">
											Pendapatan <i class="fa fa-arrow-up text-success ml-1"></i>
										</h5>
								...
								<div class="tab-pane fade show active" id="overallIncomeTab1" role="tabpanel">
									<div class="row">
										...
										<div class="col-md-3">
											...
											<div>
												<div class="media align-items-center">
													<div class="media-phpbody d-flex align-items-baseline">
